...
public class NacosServiceDiscovery implements ServiceDiscovery {
    ...
    public NacosServiceDiscovery(NacosConfigDelegation nacosConfig, String serviceName) throws NacosException {
        this.serviceName = serviceName;
        Properties properties = new Properties();
        properties.setProperty(PropertyKeyConst.SERVER_ADDR, nacosConfig.serverAddr());
        properties.setProperty(PropertyKeyConst.NAMESPACE, nacosConfig.namespace().orElse(""));
